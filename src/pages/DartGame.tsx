          ...
          <Card className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 border-amber-200">
            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                <div className="h-8 w-full bg-muted relative rounded-full overflow-hidden">
                  {/* 靶心位置標記 */}
                  <div 
                    className="absolute h-full w-[10%] bg-red-500" 
                  ...
                  {(isPlaying || showResults) && (
                    <div 
                      ...
                      style={{ left: `${playerPosition}%`, transition: "left 0.1s linear" }}
                    ></div>
                  )}
                </div>
